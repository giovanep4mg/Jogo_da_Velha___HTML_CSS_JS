 ...
 *  playerTurn = jogador. 
 *  moves = movimentos.
 *  isGameOver = acabou o jogo.
 *  restartButton = botão de reniciar o jogo.
 *  span = para guarda onde o jogador/usuário  clicou na página.
 */
...
/** vai receber o dados do span no "html",  */
...
function gameOver(a) {
    var gameOverAlertElement = "<b>FIM DE JOGO</b><br><br> Jogador =  " + span[a].dataset.player.toUpperCase() + "  ganhou, PARABÉNS !!! <br><br> Clique no botão para reniciar " + restartButton;
